...
9. Gate plus meta: verify the 14 content files exist and are non-empty, article 1000 plus words, titles fit, 5 note files match buyer order, comic-pack has cast plus 3 beats plus 5 panel prompts, video pack reads 15s max. Write drafts/YYYY-MM-DD/meta.json with date, ISO week, rotation source, model id, word counts, note to day map, source URLs, status review-ready. Move BOARD.md card to In Review PR. Append one line to MEMORY.md top hooks.
