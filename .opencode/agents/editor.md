---
description: Final gate for daily drafts. Checks voice, facts, CTA, titles, and the 10-file folder. Fails loudly instead of shipping bad drafts.
mode: subagent
temperature: 0.1
permission:
  bash: deny
...
3. note-1.md through note-5.md exist, one Note each: hook, proof, insight, story, CTA in that order. Each under 400 chars ideal, max 600. Only note-5 carries a link, using the UTM form.
